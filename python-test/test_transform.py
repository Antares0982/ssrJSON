...
class TestJSONTestSuiteTransform:
    ...
    def test_number_1e_999(self):
        ...
        number_1e-999.json
        """
        self._pass_transform("number_1e-999.json", "[0.0]")
    ...
    def test_object_same_key_different_values(self):
        ...
        """
        self._pass_transform("object_same_key_different_values.json", '{"a":2}')

    def test_object_same_key_same_value(self):
        """
        object_same_key_same_value.json
        """
        self._pass_transform("object_same_key_same_value.json", '{"a":1}')
